        ...
        <div className="flex h-full w-full">
          <div className="w-4/12 h-full">
            <div className="flex flex-col h-full w-full relative justify-between">
              <div className="w-full h-[75%] rounded-bl-[32px] rounded-br-[32px] shadow-inner backdrop-blur-[47px] flex flex-col justify-center items-center gap-10 relative !m-0">
                <Image
                ...
                <div className="absolute -bottom-[50px] w-[90%] h-[102px] px-[18px] py-8 bg-white bg-opacity-60 rounded-[32px] shadow-inner backdrop-blur-[47px] justify-center items-center gap-3.5 inline-flex">
                  <div className="text-center text-orange-950 lg:text-3xl 2xl:text-4xl font-semibold font-['Metropolis'] flex items-center gap-4">
              ...
              <div className="relative w-full h-[25%] flex flex-col items-center justify-end ">
                <ArrowLine
                  className="absolute right-0 bottom-[55px] z-10"
                  width={40}
                />
